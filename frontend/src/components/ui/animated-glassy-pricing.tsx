...
export const PricingCard = ({
  ...
  const buttonClasses = `
    ...
    \${buttonVariant === 'primary' 
      ? 'bg-primary hover:bg-tertiary text-foreground' 
      : 'bg-[#2A1A15]/10 hover:bg-[#2A1A15]/20 text-foreground border border-black/20 dark:bg-white/10 dark:hover:bg-white/20 dark:text-[#F5EFE7] dark:border-[#1A1410]/20'
    }
  `;
    ...
    <div className="bg-background text-foreground min-h-screen w-full overflow-x-hidden">
      ...
      <main className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 py-8">
        <div className="w-full max-w-5xl mx-auto text-center mb-14">
          <h1 className="text-[48px] md:text-[64px] font-extralight leading-tight tracking-[-0.03em] bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-tertiary to-blue-600 dark:from-white dark:via-tertiary dark:to-blue-400 font-display">
            {title}
          </h1>
