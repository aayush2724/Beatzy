...
export default function AppBackground() {
  ...
  return (
    <div ref={bgRef} className="fixed inset-0 z-0 overflow-hidden pointer-events-none" style={{ background: 'var(--canvas)' }}>
      <div className="absolute top-[-15%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-brand blur-[120px] animate-pulse" style={{ opacity: 0.04, animationDuration: '8s' }} />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-brand-deep blur-[150px] animate-pulse" style={{ opacity: 0.03, animationDuration: '12s' }} />
      <div className="absolute top-[30%] left-[20%] w-[40vw] h-[40vw] rounded-full bg-brand blur-[180px] animate-pulse" style={{ opacity: 0.02, animationDuration: '10s' }} />
      ...
      <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at center, transparent 15%, var(--canvas) 85%)', opacity: 0.85 }} />
    </div>
  );
}