...
export default function InteriorBackground() {
  ...
  return (
    <div ref={bgRef} className="fixed inset-0 z-[-1] bg-canvas overflow-hidden pointer-events-none">
      <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] rounded-full bg-brand opacity-[0.04] blur-[120px]" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-brand-deep opacity-[0.03] blur-[120px]" />
