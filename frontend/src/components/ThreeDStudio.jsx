  ...
  return (
    <Float speed={2} rotationIntensity={1.5} floatIntensity={2} {...props}>
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color={c.surface} roughness={0.4} metalness={0.8} />
      </mesh>
      {/* Center Label */}
...
export default function ThreeDStudio() {
  const c = usePalette();
  return (
    <div className="fixed inset-0 z-[-1] pointer-events-none bg-canvas">
      {/* Soft Vignette Overlay */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_transparent_0%,_var(--canvas)_80%)] z-10" />
      ...
      <Canvas camera={{ position: [0, 0, 10], fov: 45 }}>
        <Suspense fallback={null}>
          ...
          >
            ...
            <EqBar position={[4, 2, -4]} height={2} speed={3} color={c.brand} />
            <EqBar position={[4.5, 3, -4]} height={4} speed={4} color={c.brandDeep} />
            <EqBar position={[5, 1.5, -4]} height={1.5} speed={2} color={c.accentWarm} />
          </PresentationControls>
