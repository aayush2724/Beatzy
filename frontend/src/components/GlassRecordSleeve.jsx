  ...
  return (
    ...
    >
      ...
      <Link to={`/results/${job.id}`} className="block h-full">
        ...
        <motion.div 
            style={{ translateZ: 20 }}
            className="absolute -right-4 top-1/2 -translate-y-1/2 w-48 h-48 rounded-full bg-[#111] border-4 border-white/5 shadow-2xl group-hover:right-[-2rem] transition-all duration-500 flex items-center justify-center overflow-hidden"
        >
        ...
        >
            ...
            <div className="absolute bottom-3 left-3 right-3">
                ...
                <p className="text-white/60 text-[10px] truncate uppercase tracking-widest">{job.song_artist || 'Neural Source'}</p>
            </div>
