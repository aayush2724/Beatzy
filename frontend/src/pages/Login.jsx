    ...
    <AuthShell>
      <div className="w-full max-w-md mx-auto space-y-10 animate-page-entrance">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-5xl font-display font-black text-white uppercase tracking-tighter leading-none">Initialize <span className="text-[#c41e3a] text-glow-crimson">Session</span></h1>
        ...
        <div className="glass-card p-10 border border-white/10 relative overflow-hidden group">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="space-y-2">
                    ...
                    <div className="relative group/input">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/10 group-focus-within/input:text-[#c41e3a] transition-colors" />
                        <input
                            type="email"
                            required
                            value={email}
                            onChange={(e) => setEmail(e.target.value)}
                            className="w-full h-14 bg-white/[0.03] border border-white/10 rounded-2xl pl-12 pr-4 text-white placeholder:text-white/20 focus:outline-none focus:border-[#c41e3a]/40 transition-all"
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative group/input">
                        <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/10 group-focus-within/input:text-[#c41e3a] transition-colors" />
                        <input
                            type="password"
                            required
                            value={password}
            ...
            <div className="relative z-10 mt-10 space-y-6">
                ...
                >
                    <Chrome className="w-4 h-4 text-[#f4a460]" /> Google Auth Uplink
                </button>
            </div>
        </div>
        ...
        <div className="text-center space-y-6">
            ...
            <div className="flex justify-center items-center gap-4">
                ...
                <Link to="/register" className="group flex items-center gap-2 text-[11px] font-black text-[#c41e3a] uppercase tracking-widest hover:text-white transition-colors">
