    ...
    <AuthShell>
      <div className="w-full max-w-md mx-auto space-y-10 animate-page-entrance">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-black text-[#FFFFFF] tracking-tight">Sign in to <span className="text-[#FF6B35] text-glow-orange">Beatzy</span></h1>
        ...
        <div className="text-center space-y-4">
            <div className="flex justify-center items-center gap-2">
                <span className="text-sm text-[#FFFFFF]/40">Don't have an account?</span>
                <Link to="/register" className="group flex items-center gap-1.5 text-sm font-bold text-[#FF6B35] hover:text-[#FFFFFF] transition-colors">
