...
export default function BillingSuccess() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#1A1410] text-[#1A1410] font-body selection:bg-white/20 flex flex-col justify-between">
      ...
      <div className="relative z-10 flex-grow flex items-center justify-center p-8">
        ...
        >
          <div className="relative inline-block">
            ...
            <span
              className="material-symbols-outlined text-[64px] text-[#1A1410] relative select-none leading-none"
          ...
          <div>
            <h1 className="font-headline text-2xl font-bold text-[#1A1410] tracking-tight mb-2">Payment confirmed</h1>
          ...
          <div className="grid grid-cols-2 gap-4 bg-white/[0.02] border border-[#1A1410]/10 p-4 rounded-lg text-left">
            <div>
              ...
              <span className="font-mono text-[10px] font-bold text-[#1A1410] uppercase">Pro active</span>
            </div>
            <div className="text-right">
              <span className="font-mono text-[8px] text-gray-500 uppercase tracking-widest block mb-0.5">Sync</span>
              <span className="font-mono text-[10px] font-bold text-[#1A1410] uppercase flex items-center justify-end gap-1.5">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span
              className={`font-mono text-[8px] uppercase tracking-widest transition-colors ${
                syncComplete ? 'text-[#1A1410]' : 'text-gray-500'
              }`}
            >
          ...
          <div className={`transition-all duration-700 delay-[1200ms] ${syncComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <p className="mt-4 font-mono text-[9px] text-gray-500 uppercase tracking-widest">
              Redirecting in <span className="text-[#1A1410] font-bold">{countdown}</span>s
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="relative z-10 w-full py-6 px-8 border-t border-[#1A1410]/10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 font-mono text-[8px] uppercase tracking-widest text-gray-500">
            <Link className="hover:text-[#1A1410] transition-colors" to="/privacy">Privacy</Link>
            <Link className="hover:text-[#1A1410] transition-colors" to="/terms">Terms</Link>
          </div>
        </div>
      </footer>
    </div>
