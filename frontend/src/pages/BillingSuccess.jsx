      ...
      <div className="relative z-10 flex-grow flex items-center justify-center p-8">
        ...
        >
          <div className="relative inline-block">
            ...
            <span
              className="material-symbols-outlined text-[64px] text-white relative select-none leading-none"
          ...
          <div>
            <h1 className="font-headline text-2xl font-bold text-white tracking-tight mb-2">Payment confirmed</h1>
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs mx-auto">
              Your plan is active. Syncing your account…
            </p>
          </div>

          <div className="grid grid-cols-2 gap-4 bg-white/[0.02] border border-white/10 p-4 rounded-lg text-left">
            <div>
              <span className="font-mono text-[8px] text-gray-500 uppercase tracking-widest block mb-0.5">Plan</span>
              <span className="font-mono text-[10px] font-bold text-white uppercase">Pro active</span>
            </div>
            <div className="text-right">
              <span className="font-mono text-[8px] text-gray-500 uppercase tracking-widest block mb-0.5">Sync</span>
              <span className="font-mono text-[10px] font-bold text-white uppercase flex items-center justify-end gap-1.5">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span
              className={`font-mono text-[8px] uppercase tracking-widest transition-colors ${
                syncComplete ? 'text-white' : 'text-gray-500'
              }`}
            >
          ...
          <div className={`transition-all duration-700 delay-[1200ms] ${syncComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <p className="mt-4 font-mono text-[9px] text-gray-500 uppercase tracking-widest">
              Redirecting in <span className="text-white font-bold">{countdown}</span>s
            </p>
          </div>
        </div>
      </div>

      <footer className="relative z-10 w-full py-6 px-8 border-t border-white/10">
