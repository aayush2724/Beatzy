    ...
    <PageWrapper className="space-y-12 pb-20 animate-page-entrance">
        ...
        <header className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 border-b border-[#1A1410]/5 pb-12 relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <h1 className="text-6xl font-display font-black text-[#F5EFE7] tracking-tighter uppercase leading-none">Signal <span className="text-[#C41E3A] text-glow-red">Archives</span></h1>
              <p className="font-mono text-[10px] text-[#F5EFE7]/30 uppercase tracking-[0.3em]">{pagination.total} Waveforms indexed in neural core</p>
            </div>
        ...
        {loading ? (
            ...
            <div className="h-80 glass-card border-red-500/20 flex flex-col items-center justify-center text-center p-12 gap-8">
                ...
                <div className="space-y-2">
                    <p className="text-[#F5EFE7] text-lg font-display font-black uppercase tracking-tight">Archives Offline</p>
            ...
            <div className="h-80 obsidian-panel rounded-[3rem] border border-dashed border-[#1A1410]/5 flex flex-col items-center justify-center text-center p-12">
                <div className="w-20 h-20 bg-white/5 rounded-[2rem] flex items-center justify-center mb-8 border border-[#1A1410]/5">
                    <Disc className="w-10 h-10 text-[#F5EFE7]/10" />
                </div>
                <h3 className="text-2xl font-display font-black text-[#F5EFE7] uppercase tracking-tight mb-3">Archive Registry Empty</h3>
                ...
                {pagination.pages > 1 && (
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-8 pt-16 border-t border-[#1A1410]/5">
                        <button 
                            ...
                            className="flex items-center gap-3 px-8 py-4 rounded-xl border border-[#1A1410]/5 bg-white/[0.02] text-[#F5EFE7]/40 hover:text-[#F5EFE7] hover:border-[#1A1410]/20 transition-all disabled:opacity-10 font-mono text-[10px] font-black uppercase tracking-[0.2em]"
                        >
                            <ChevronLeft className="w-4 h-4" /> Previous Sector
                        </button>
                        <div className="px-6 py-2 rounded-lg bg-white/5 border border-[#1A1410]/5">
                            <span className="font-mono text-[10px] text-[#F5EFE7] font-black uppercase tracking-[0.2em]"><span className="text-[#C41E3A]">{page}</span> <span className="opacity-20 mx-2">/</span> {pagination.pages}</span>
                        </div>
                        <button 
