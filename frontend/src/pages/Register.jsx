    ...
    <AuthShell>
      <div className="w-full max-w-md mx-auto space-y-10 animate-page-entrance">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-5xl font-display font-black text-[#FFFFFF] uppercase tracking-tighter leading-none">Register <span className="text-[#FF6B35] text-glow-ember">Operator</span></h1>
        ...
        <div className="glass-card p-10 border border-[#0D0808]/10 relative overflow-hidden group">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="space-y-2">
                    <label className="font-mono text-[10px] text-[#FFFFFF]/30 uppercase tracking-[0.3em] ml-1">Interface Label</label>
                    <div className="relative group/input">
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#FFFFFF]/10 group-focus-within/input:text-[#FF6B35] transition-colors" />
                        <input
                            type="text"
                            required
                            value={formData.name}
                ...
                <div className="space-y-2">
                    <label className="font-mono text-[10px] text-[#FFFFFF]/30 uppercase tracking-[0.3em] ml-1">Spectral Email</label>
                    <div className="relative group/input">
                ...
                <div className="space-y-2">
                    <label className="font-mono text-[10px] text-[#FFFFFF]/30 uppercase tracking-[0.3em] ml-1">New Access Key</label>
                    <div className="relative group/input">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full h-16 rounded-2xl bg-[#FF6B35] text-black font-black text-xs uppercase tracking-[0.2em] shadow-[0_0_40px_rgba(244,164,96,0.2)] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                >
                    {loading ? (
            ...
            <div className="relative z-10 mt-10 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <span className="font-mono text-[9px] text-[#FFFFFF]/20 uppercase tracking-[0.3em]">Or use automated uplink</span>
                    <div className="h-px flex-1 bg-white/5" />
                </div>
                ...
                >
                    <Chrome className="w-4 h-4 text-[#FF6B35]" /> Google Registry Sync
                </button>
            </div>
        </div>
        ...
        <div className="text-center space-y-6">
            <p className="text-[10px] font-mono text-on-surface-variant uppercase tracking-widest leading-relaxed">
                ...
                <Link to="/terms" className="text-[#FFFFFF] hover:text-[#FF6B35] transition-colors">Service Terms</Link> and <Link to="/privacy" className="text-[#FFFFFF] hover:text-[#FF6B35] transition-colors">Privacy Protocol</Link>.
            </p>
            <div className="flex justify-center items-center gap-4">
                <span className="text-[11px] text-[#FFFFFF]/30 uppercase tracking-widest">Already Registered?</span>
                <Link to="/login" className="group flex items-center gap-2 text-[11px] font-black text-[#FF6B35] uppercase tracking-widest hover:text-[#FFFFFF] transition-colors">
