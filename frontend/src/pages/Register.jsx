    ...
    <AuthShell>
      <div className="w-full max-w-md mx-auto space-y-10 animate-page-entrance">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-black text-ink tracking-tight">Create your <span className="text-brand text-glow-orange">account</span></h1>
        ...
        <div className="glass-card p-8 md:p-10 border border-line relative overflow-hidden group">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="space-y-2">
                    <label className="text-sm text-ink/60 font-medium ml-1">Full Name</label>
                    <div className="relative group/input">
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-ink/20 group-focus-within/input:text-brand transition-colors" />
                        <input
                            type="text"
                            required
                            value={formData.name}
        ...
        <div className="text-center space-y-4">
            <p className="text-xs text-ink/30 leading-relaxed">
                ...
                <Link to="/terms" className="text-ink hover:text-brand transition-colors underline underline-offset-2">Terms of Service</Link> and{' '}
                <Link to="/privacy" className="text-ink hover:text-brand transition-colors underline underline-offset-2">Privacy Policy</Link>.
            </p>
            <div className="flex justify-center items-center gap-2">
                <span className="text-sm text-ink/40">Already have an account?</span>
                <Link to="/login" className="group flex items-center gap-1.5 text-sm font-bold text-brand hover:text-ink transition-colors">
