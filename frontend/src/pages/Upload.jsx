...
import { uploadAudio, getResults } from '../api/audio';
    ...
    <div className="space-y-5 pb-16">
      <header className="mb-6">
        ...
        <p className="font-sans text-sm text-on-surface-variant mt-1">
          Upload audio for AI-powered song identification, tempo detection, mood analysis, and spectral classification.
        </p>
      </header>
            ...
            {step === 'upload' && (
              ...
              >
                ...
                <div className="mt-6 grid grid-cols-3 gap-3 text-center">
                  {[
                    { icon: 'fingerprint', label: 'Song Identification', sub: 'ACRCloud' },
                    { icon: 'equalizer', label: 'Spectral Analysis', sub: 'librosa AI' },
                    { icon: 'mood', label: 'Mood Detection', sub: 'ML Model' },
                  ].map(f => (
