    ...
    <div className="min-h-screen bg-canvas text-ink font-body selection:bg-brand/30 selection:text-canvas">
      <div className="max-w-3xl mx-auto px-8 py-24 space-y-16 animate-page-entrance">
        ...
        <header className="space-y-6">
          ...
          <h1 className="text-6xl font-display font-black text-ink uppercase tracking-tighter leading-none">Privacy <span className="text-brand text-glow-orange">Protocol</span></h1>
        ...
        <footer className="text-center pt-10">
            <p className="font-mono text-[9px] text-ink/10 uppercase tracking-[0.4em]">Contact: privacy@beatzy.io · Node: Region-EU-1</p>
        </footer>
      </div>
    </div>
  );
