...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-[#050505] text-white font-body selection:bg-[#CCFF00]/30 selection:text-black">
      <div className="max-w-3xl mx-auto px-8 py-24 space-y-16 animate-page-entrance">
        <Link to="/" className="group inline-flex items-center gap-2 font-mono text-[10px] text-white/30 uppercase tracking-widest hover:text-[#CCFF00] transition-colors">
          <ChevronLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" /> Back to Network
        </Link>

        <header className="space-y-6">
          <div className="inline-flex items-center gap-3 px-3 py-1 rounded-full border border-[#CCFF00]/20 bg-[#CCFF00]/5 text-[#CCFF00] font-mono text-[9px] uppercase tracking-[0.2em]">
            <ShieldCheck className="w-3 h-3" /> Data Integrity Protocol
          </div>
          <h1 className="text-6xl font-display font-black text-white uppercase tracking-tighter leading-none">Privacy <span className="text-[#CCFF00] text-glow-lime">Protocol</span></h1>
