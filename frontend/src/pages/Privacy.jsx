    ...
    <div className="min-h-screen bg-[#1A1410] text-[#F5EFE7] font-body selection:bg-[#C41E3A]/30 selection:text-black">
      <div className="max-w-3xl mx-auto px-8 py-24 space-y-16 animate-page-entrance">
        ...
        <header className="space-y-6">
          ...
          <h1 className="text-6xl font-display font-black text-[#F5EFE7] uppercase tracking-tighter leading-none">Privacy <span className="text-[#C41E3A] text-glow-red">Protocol</span></h1>
        ...
        <footer className="text-center pt-10">
            <p className="font-mono text-[9px] text-[#F5EFE7]/10 uppercase tracking-[0.4em]">Contact: privacy@beatzy.io · Node: Region-EU-1</p>
        </footer>
      </div>
    </div>
  );
